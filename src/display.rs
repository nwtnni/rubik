...
const O: color::Fg<&'static dyn color::Color> = color::Fg(&color::LightRed);
    ...
    fn fmt(&self, fmt: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(
            ...
            {}                {}\n\n\
                ...
                {}    {}\n\n\
                    {}    {}{}\n\n",
            self[11], self[10], self[19], self[18],
            self[04], self[09], self[00], self[03],
            self[12], self[17], self[01], self[02],
            self[05], self[08], self[06], self[07],
            self[13], self[16], self[14], self[15],
